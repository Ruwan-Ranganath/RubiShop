            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <aside class="tray tray-right tray290 va-t pn" data-tray-height="match">
                    ...
                    <div class="p20 admin-form">
                        ...
                        <h4 class="mt5 text-muted fw500"> Find Customer</h4>
                        ...
                        <div class="section mb10">
                            <label for="customer-name" class="field prepend-icon">
                                ...
                                <label for="customer-name" class="field-icon"><i class="fa fa-user"></i>
                                </label>
                            </label>
                        </div>
                        <div class="section mb25">
                            <label for="customer-email" class="field prepend-icon">
                                ...
                                <label for="customer-email" class="field-icon"><i class="fa fa-envelope-o"></i>
                                </label>
                            </label>
                        </div>

                        <h6 class="fw400">Search Country</h6>
                        <div class="section mb15">
                            <label class="field select">
                        ...
                        <h6 class="fw400">Search Company</h6>
                        <div class="section mb15">
                            <label class="field select">
                        ...
                        <h6 class="fw400">Registration Date</h6>
                        <div class="section row">
                            <div class="col-md-6">
