            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="tray tray-center p25 va-t posr">
                    ...
                    <div class="panel mb25 mt5">
                        <div class="panel-heading">
                            <span class="panel-title">Create New Order</span>
                            <ul class="nav panel-tabs-border panel-tabs">
                                <li class="active">
                                    <a href="#tab1_1" data-toggle="tab">Customer Info</a>
                                </li>
                                <li>
                                    <a href="#tab1_2" data-toggle="tab">Payment Info</a>
                                </li>
                                <li>
                                    <a href="#tab1_3" data-toggle="tab">Shipping Info</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div id="tab1_2" class="tab-pane">
                                    ...
                                    <div class="section">
                                        <label for="cardname" class="field prepend-icon">
                                            ...
                                            <label for="cardname" class="field-icon"><i class="fa fa-user"></i>
                                            </label>
                                        </label>
                                    </div>
                                    <!-- end section -->
                                    ...
                                    <div class="section row">
                                        <div class="col-md-6">
                                            <label for="secno" class="field prepend-icon">
                                                ...
                                                <label for="secno" class="field-icon"><i class="fa fa-barcode"></i>
                                                </label>
                                            </label>
                                        </div>
                                        <!-- end section -->
                                        ...
                                        <div class="col-md-6">
                                            <p class="input-align">
                                                <a href="#" class="smart-link"> What is this? </a>
                                            </p>
                                        </div>
                                        <!-- end section -->
                            ...
                            <table class="table admin-form theme-warning tc-checkbox-1 fs13">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="w175">
                                            <img class="img-responsive mw20 ib mr10" title="user" src="assets/img/avatars/1.jpg"> <span>Louis Renold</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">#50362061</td>
                                        <td class="w175">
                                            <img class="img-responsive mw20 ib mr10" title="user" src="assets/img/avatars/2.jpg"> <span>Sara Loft</span>
                                        </td>
                                        <td class="">Lorem ipsum dolor sit amet, adipiscing eli</td>
                                        <td class="text-right">
                                            <div class="btn-group text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="">#50362061</td>
                                        <td class="w175">
                                            <img class="img-responsive mw20 ib mr10" title="user" src="assets/img/avatars/3.jpg"> <span>Frank Roles</span>
                                        </td>
                                        <td class="">Lorem ipsum dolor sit amet, adipiscing eli</td>
                                        <td class="text-right">
                                            <div class="btn-group text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="">#50362061</td>
                                        <td class="w175">
                                            <img class="img-responsive mw20 ib mr10" title="user" src="assets/img/avatars/4.jpg"> <span>Michael Runes</span>
                                        </td>
                                        <td class="">Lorem ipsum dolor sit amet, adipiscing eli</td>
                                        <td class="text-right">
                                            <div class="btn-group text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="">#50362061</td>
                                        <td class="w175">
                                            <img class="img-responsive mw20 ib mr10" title="user" src="assets/img/avatars/5.jpg"> <span>Amanda Marshall</span>
                                        </td>
                                        <td class="">Lorem ipsum dolor sit amet, adipiscing eli</td>
                                        <td class="text-right">
                                            <div class="btn-group text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="">#50362061</td>
                                        <td class="w175">
                                            <img class="img-responsive mw20 ib mr10" title="user" src="assets/img/avatars/1.jpg"> <span>Terry Planes</span>
                                        </td>
                                        <td class="">Lorem ipsum dolor sit amet, adipiscing eli</td>
                                        <td class="text-right">
                                            <div class="btn-group text-right">
                ...
                <aside class="tray tray-right tray290 va-t pn" data-tray-height="match">
                    ...
                    <div class="p20 admin-form">
                        ...
                        <h4 class="mt5 text-muted fw500"> Filter Orders</h4>
